...
public class DmAPIException extends Exception {
     ...
     * @since 1.4
     */
    public DmAPIException(String message, Throwable cause, Object requestParams) {
        super(message, cause);
     ...
     * @since 1.4
     */
    public DmAPIException(Throwable cause, Object requestParams) {
        super(cause);
        this.requestParams = requestParams;
    }
    ...
    public DmAPIException(Object requestParams){
        this.requestParams = requestParams;
    }
     ...
     * @since 1.7
     */
    public DmAPIException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
